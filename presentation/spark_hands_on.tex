...
\begin{frame}
  ...
  \lstinputlisting[language=scala, style=code, label=Exercise1,caption=/src/main/scala/psug/hands/on/exercise01/SumOfSquaresOfNonPrimeNumbers.scala]{../src/main/scala/psug/hands/on/exercise01/SumOfSquaresOfNonPrimeNumbers.scala}
...
\begin{frame}
  ...
  \lstinputlisting[language=scala, style=code, label=Exercise2,caption=/src/main/scala/psug/hands/on/exercise02/RiversMatcher.scala]{../src/main/scala/psug/hands/on/exercise02/RiversMatcher.scala}
...
%--- EX4 : New DataFrame Transformations ---
\begin{frame}
